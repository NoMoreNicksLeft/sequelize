    ...
    attributeToSQL: function(attribute, options) {
      ...
      if (attribute.validate) {
        ...
        if (attribute.validate.isEmail) {
          ...
          // This is a mess. It's escapes all the way down. Doesn't match Sequelize's test, found at:
          ...
          template += ' CHECK ("<%= columnName %>" ~ ' + String.fromCharCode(39) 
                   + '^[0-9a-zA-Z!#$%&' + String.fromCharCode(39) + String.fromCharCode(39) 
                   + '*+-/=?^_`{|}~.]{1,64}@([0-9a-z-]+\\.)*[0-9a-z-]+$' + String.fromCharCode(39)
                   + ' AND "<%= columnName %>" !~ ' + String.fromCharCode(39) + '(^\\.|\\.\\.|\\.@)'
                   + String.fromCharCode(39) + ' AND "<%= columnName %>" ~ ' + String.fromCharCode(39) + '@.{1,255}'
